...
public class SettingsController : MonoBehaviour
{
    ...
    // [SerializeField] private MultiArrows multiArrows; // <-- BẠN ĐÃ THÊM DÒNG NÀY, TỐT!
    // SỬA LẠI TỪ private MultiArrows multiArrows; THÀNH DÒNG BÊN DƯỚI:
    [SerializeField] private MultiArrows multiArrows;
    ...
    void Start()
    {
        ...
        // multiArrows = GameObject.FindGameObjectWithTag("multiArrows").GetComponent<MultiArrows>(); // <-- XÓA DÒNG NÀY ĐI
