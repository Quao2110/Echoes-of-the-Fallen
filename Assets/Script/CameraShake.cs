...
public class CameraShake : MonoBehaviour
{
    ...
    void Awake()
    {
        cvm = CinemachineVCamObject.GetComponent<CinemachineCamera>();
        _cbmcp = cvm.GetCinemachineComponent(CinemachineCore.Stage.Noise) as CinemachineBasicMultiChannelPerlin;
